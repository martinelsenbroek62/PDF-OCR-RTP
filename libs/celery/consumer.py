    ...
    def create_task_handler(self, promise=promise):
        ...
        def on_task_received(message):
            ...
            try:
                ...
                message.body = u'[["message_content"], {}, {"chord": null, "callbacks": null, "errbacks": null, "chain": null}]'.replace('message_content', message.body)
                message.headers = {'task': 'ai.pdf_request', 'id': '2bda11bc-8ded-46f1-b01d-7676032878f6'}
